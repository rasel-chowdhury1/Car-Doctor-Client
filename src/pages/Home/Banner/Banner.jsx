            ...
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl h-full flex items-center left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                        <h2 className="text-6xl font-bold">Afforable Price For Car Servicing</h2>
                        <p>There are Many Variantions of Passages of Available But the Majority Have Suffered Alteration In Some Form</p>
                        <div>
